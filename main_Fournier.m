...
volume.main =       1.0;	% volume bulk in L
volume.injection =	0.004;	% volume acid in L
...
%Examined tm (tm does not resemble the micromixing time)
tm = 0.01;

%Interval of integration
%tend is the actual micromixing time
